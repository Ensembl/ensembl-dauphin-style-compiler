...
use peregrine_data::{AllotmentRequest, Colour, DirectColour, Patina, Pen, Plotter, SpaceBase, ZMenu, SpaceBase2};
...
impl GeometryBuilder {
    ...
    builder_type!(spacebase,add_spacebase,SpaceBase,SpaceBase2<f64,()>,"spacebase");
}
