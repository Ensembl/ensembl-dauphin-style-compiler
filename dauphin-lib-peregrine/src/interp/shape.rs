...
simple_interp_command!(Rectangle2InterpCommand,Rectangle2Deserializer,19,7,(0,1,2,3,4,5,6));
simple_interp_command!(Rectangle1InterpCommand,Rectangle1Deserializer,20,7,(0,1,2,3,4,5,6));
...
impl InterpCommand for Rectangle2InterpCommand {
    fn execute(&self, context: &mut InterpContext) -> anyhow::Result<CommandResult> {
        ...
        zoo.rectangle().add_rectangle_2(AnchorPair(AnchorPairAxis(sea_x,ship_x0,ship_x1),
                                        ...
                                        Patina::Filled(Colour::Direct(vec![DirectColour(0,0,0)])),allotment);
