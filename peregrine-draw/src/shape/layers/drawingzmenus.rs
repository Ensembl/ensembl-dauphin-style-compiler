...
use peregrine_data::{Allotment, EachOrEvery, Scale, ZMenu, ZMenuGenerator, ZMenuProxy, SpaceBaseArea, SpaceBasePointRef, SpaceBasePoint, transform_spacebase, CoordinateSystem, transform_spacebasearea};
...
struct ZMenuUnscaledEntry {
    ...
    area: SpaceBaseArea<f64,Allotment>
}
...
impl DrawingZMenusBuilder {
    ...
    pub(crate) fn add_rectangle(&mut self, area: SpaceBaseArea<f64,Allotment>, zmenu: ZMenu, values: Vec<(String,EachOrEvery<String>)>) {
...
impl ScaledZMenus {
    ...
    fn maximum_footprint(&self, top_left: &SpaceBasePointRef<f64,Allotment>, bottom_right: &SpaceBasePointRef<f64,Allotment>) -> ((f64,u64),(f64,u64)) {
        /* y-coordinate */
    ...
    // TODO no-bp zmenus
    fn get_zones(&self, top_left: &SpaceBasePointRef<f64,Allotment>, bottom_right: &SpaceBasePointRef<f64,Allotment>) -> Vec<u64> {
