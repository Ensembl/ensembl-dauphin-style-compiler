...
use super::geometry::{GeometryProgram, GeometryProgramName, GeometryYielder};
...
impl Layer {
    ...
    fn shape_program(&mut self, geometry: &GeometryProgramName, patina: &PatinaProcessName) -> Result<&mut ShapeProgram,Message> {
