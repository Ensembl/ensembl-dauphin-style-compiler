...
lazy_static! {
    static ref CONFIG_CONFIG : Vec<ConfigKeyInfo<'static,PgConfigKey,PgConfigValue>> = {
        vec![
            ...
            ConfigKeyInfo { key: PgConfigKey::AnimationFadeRate(CarriageSpeed::Quick), name: "animate.fade.fast", default: &PgConfigValue::Float(20.) },
            ConfigKeyInfo { key: PgConfigKey::AnimationFadeRate(CarriageSpeed::SlowCrossFade), name: "animate.fade.slow-cross", default: &PgConfigValue::Float(50.) },
            ConfigKeyInfo { key: PgConfigKey::AnimationFadeRate(CarriageSpeed::Slow), name: "animate.fade.slow", default: &PgConfigValue::Float(40.) },
            ...
            ConfigKeyInfo { key: PgConfigKey::AnimationBoing, name: "animate.boing", default: &PgConfigValue::Float(2.15) },
            ...
            ConfigKeyInfo { key: PgConfigKey::UserDragLethargy, name: "animate.lethargy.user-drag", default: &PgConfigValue::Float(5.) },
            ...
            ConfigKeyInfo { key: PgConfigKey::GotoRho, name: "zoom.goto.rho", default: &PgConfigValue::Float(1.0) },
            ConfigKeyInfo { key: PgConfigKey::GotoV, name: "zoom.goto.v", default: &PgConfigValue::Float(0.001) },
