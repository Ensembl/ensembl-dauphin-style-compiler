...
lazy_static! {
    static ref CONFIG_CONFIG : Vec<ConfigKeyInfo<'static,PgConfigKey,PgConfigValue>> = {
        vec![
            ...
            //ConfigKeyInfo { key: PgConfigKey::GotoRho, name: "zoom.goto.rho", default: &PgConfigValue::Float(1.42) },
            //ConfigKeyInfo { key: PgConfigKey::GotoV, name: "zoom.goto.v", default: &PgConfigValue::Float(0.003) },
            ConfigKeyInfo { key: PgConfigKey::GotoRho, name: "zoom.goto.rho", default: &PgConfigValue::Float(1.5) },
            ConfigKeyInfo { key: PgConfigKey::GotoV, name: "zoom.goto.v", default: &PgConfigValue::Float(0.002) },
