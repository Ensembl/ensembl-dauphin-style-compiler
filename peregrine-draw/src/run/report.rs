...
use peregrine_data::{AllotmentMetadataReport, ZMenuFixed, AllotmentMetadataReport2};
...
impl ReportData {
    ...
    fn set_allotter_metadata(&self, metadata: &AllotmentMetadataReport2) {
...
impl Report {
    ...
    pub(crate) fn set_allotter_metadata(&self, metadata: &AllotmentMetadataReport2) {
