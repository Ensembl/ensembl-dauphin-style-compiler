...
dauphin -c $SRC/v15/startup.egs -c $SRC/v15/lookup.egs -c $SRC/v15/jump.egs -o $DST/stick15.begs -L peregrine -O2
dauphin -c $SRC/v15/boot.egs -o $DST/boot15.begs -L peregrine -O2
