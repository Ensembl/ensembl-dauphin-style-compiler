...
dauphin -c $SRC/gene8.egs -c $SRC/transcript8.egs -c $SRC/gc8.egs -c $SRC/variant8.egs -c $SRC/contig8.egs -c $SRC/ruler8.egs -c $SRC/framing8.egs -o $DST/render8.begs -L peregrine -O2 
