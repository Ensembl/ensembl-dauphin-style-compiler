...
dauphin -c $SRC/v16/focus-region.egs -c $SRC/v16/zoomed-transcript.egs -c $SRC/v16/focus-zoomed-transcript.egs -o $DST/render16.begs -L peregrine -O2 
...
eard-compiler \
    ...
    -c $SRC/v16/focus-gene-dots.eard -c $SRC/v16/transcript.eard \
    -c $SRC/v16/focus-transcript.eard \
