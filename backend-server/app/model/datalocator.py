...
class AccessItem(object):
    ...
    variety_map = {
        ...
        "gc": "gc/{genome}/gc.bw",
        "variant-labels": "variants/{genome}/bed_correction_dbSNP_processed_VEP.bb",
        "variant-labels-dbsnp": "variants/{genome}/bed_correction_dbSNP_processed_VEP.bb",
        ...
        "variant-dbsnp-summary": "variants/{genome}/bed_correction_dbSNP_processed_VEP.bw",
        ...
        "variant-summary": "variants/{genome}/bed_correction_dbSNP_processed_VEP.bw",
