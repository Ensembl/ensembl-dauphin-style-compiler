...
impl DrawingCarriage2 {
    pub(super) fn new(extent: &CarriageExtent, try_lifecycle: &Needed, carriage_output: &CarriageOutput, train_state: &TrainState3) -> Result<DrawingCarriage2,DataMessage> {
