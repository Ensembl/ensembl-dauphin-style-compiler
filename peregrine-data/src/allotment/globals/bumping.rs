...
use peregrine_toolkit::{puzzle::{StaticValue, constant, compose, StaticAnswer, derived}, lock, log};

use crate::{allotment::{style::allotmentname::AllotmentName, util::rangeused::RangeUsed, collision::{concretebump::{ConcreteRequests, ConcreteBump, ConcreteRequest, ConcreteResults}, collisionalgorithm2::{BumpRequestSet, BumpResponses}}}};
