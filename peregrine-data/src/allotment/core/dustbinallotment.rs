use crate::{CoordinateSystem, SpaceBasePointRef, spacebase::spacebase::SpaceBasePoint, AllotmentMetadataRequest, CoordinateSystemVariety};
...
impl Transformer for DustbinAllotment {
    fn coord_system(&self) -> CoordinateSystem { CoordinateSystem(CoordinateSystemVariety::Window,false) }
